...
public class NewTagApply extends JFrame implements ActionListener  {
	...
	public NewTagApply() {
		...
		JLabel lblTollPayment = new JLabel("New Tag Apply");
		...
		textField.setBounds(374, 102, 116, 22);
		contentPane.add(textField);
		textField.setColumns(10);
		
		JLabel lblVehicleReg = new JLabel("Vehicle reg");
