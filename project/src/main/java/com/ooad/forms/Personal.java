...
public class Personal extends JFrame implements ActionListener {
	...
	public Personal() {
		...
		JLabel lblTollPayment = new JLabel("PERSONAL INFO");
		...
		txtYousufBilal.setText("Yousuf Bilal");
		...
		JLabel lblAmountDue = new JLabel("Address");
		...
		txtUniversitySt.setText("978 University St. Roselle, IL 60172.");
		...
		JLabel lblDueDate = new JLabel("Email");
		...
		txtSomeonesomeonecom.setText("someone@Someone.com");
		...
		JLabel lblDriversLicense = new JLabel("Phone number");
